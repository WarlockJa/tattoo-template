/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 03c3279064e3077b66770c21086fc937)
// Runtime types generated with workerd@1.20251210.0 2025-03-10 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_R2_URI: string;
		NEXT_PUBLIC_GOOGLE_MAPS_API_KEY: string;
		NEXT_PUBLIC_GOOGLE_MAP_ID: string;
		BLURHASHWORKER_URL: string;
		BLURHASHWORKER_HEADER: string;
		BLURHASHWORKER_ACCESS_KEY: string;
		SMTP_URI: string;
		SMTP_FROM: string;
		SMTP_API_KEY: string;
		...
		R2: R2Bucket;
		DB: D1Database;
		CWBlurhash: Fetcher /* blurhash-worker */;
